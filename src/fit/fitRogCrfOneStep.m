function [x_pair,x_ind] = fitRogCrfOneStep(spikes,cont,mu_eta,cov_eta,optional)
    arguments
        spikes (2,:,:);
        cont (1,:);
        mu_eta (2,1);
...
%     end
        ...
        [x_pair,x_ind] = fitRogCrfOneStepInner(mu_hat,sigma_hat,cont,mu_eta,var_eta,rho_eta,optional.tuning,optional.optimopts);
end