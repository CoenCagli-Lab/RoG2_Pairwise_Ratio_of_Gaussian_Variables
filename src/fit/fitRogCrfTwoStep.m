function [x_pair,x_ind] = fitRogCrfTwoStep(spikes,cont,mu_eta,cov_eta,optional)
   arguments
        spikes (2,:,:);
        cont (1,:);
        mu_eta (2,1);
    ...
    [x_pair,x_ind] = fitRogCrfTwoStepInner(mu_hat,sigma_hat,cont,mu_eta,var_eta,rho_eta,optional.tuning,optional.optimopts);
end