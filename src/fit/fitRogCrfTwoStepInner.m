function [x_pair,x_ind] = fitRogCrfTwoStepInner(mu_hat,sigma_hat,cont,mu_eta,var_eta,rho_eta,tuning,opts)
% fitRogTwoStepInner Inner loop for fitting the RoG in two steps
